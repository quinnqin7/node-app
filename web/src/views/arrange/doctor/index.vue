<template>
    <div class="app_first">
        ...
        <div>
            ...
            <!-- 日期 -->
            <div class="block">
                <el-date-picker v-model="todayTime_value" type="date" placeholder="选择日期"
            ...
            <div class="block block_small">
                <el-select v-model="office_value" placeholder="所有科室">
                    <el-option v-for="item in office_options" :key="item.office_value" :label="item.office_label"
            ...
            <div class="block block_small">
                <el-select v-model="type_value" placeholder="所有类型">
                    <el-option v-for="item in type_options" :key="item.type_value" :label="item.type_label"
            ...
            <div class="block block_small">
                <el-select v-model="doctor_value" placeholder="所有人">
                    <el-option v-for="item in doctor_options" :key="item.doctor_value" :label="item.doctor_label"
            ...
            <table border="1" cellspacing="0">
                <tr>
                    <td v-for="(item,index) in items">
                        ...
                        <!-- 周几 -->
                        <span v-model="which_weekDay"
                              v-if="(which_weekDay+index)<7">{{ dayNames[which_weekDay+index]}}</span>
                ...
                <tr class="td_65px">
                    ...
                    <td v-for="(item,week_index) in items">
							<span v-for="(item1,todo_index) in item.todos" @click="find_index(week_index,todo_index)"
                                  v-bind:class="{ add_catchUp_myClass : item1.active , findIndex_myClass : item1.findIndex_active}">
								<br>
								{{ item1.text }}
								<br>
								{{ item1.time_start }}
